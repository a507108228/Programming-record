<template>
    <div class="app-container">
        <h1 style="text-align: center">Banner列表</h1>
        ...
        <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item>
                <el-input v-model="bannerQuery.linkUrl" placeholder="url链接" />
            </el-form-item>
            ...
            getList(page = 1) {
                ...
                banner.getBannerListPage(this.page, this.limit, this.bannerQuery)
                    .then(response => {
                        ...
                        console.log("这个是数据" + this.list)
                        console.log("这个是总数" + this.total)
                    })
                    .catch(response => {
                        console.error("Banner列表出错");
                    })
            },
