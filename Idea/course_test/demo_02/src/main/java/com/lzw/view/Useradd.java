...
public class Useradd extends IndexAdmin{
	...
	public void init() {
		...
		usertitle.setFont(d);
		username.setBounds(160, 140, 80, 30);
		username.setFont(f);
		name.setBounds(240, 140, 150, 30);
		name.setFont(f);
		userpwd.setBounds(160, 200, 80, 30);
		userpwd.setFont(f);
		pwd.setBounds(240, 200, 150, 30);
		pwd.setFont(f);
		userstyle.setBounds(160, 260, 80, 30);
		userstyle.setFont(f);
		style.setBounds(240, 260, 150, 30);
		style.setFont(f);
